...
function SDesStreamEncrypt(options) { SDesStreamEncrypt.super_.apply(this, arguments); };
function SDesStreamDecrypt(options) { SDesStreamDecrypt.super_.apply(this, arguments); };
